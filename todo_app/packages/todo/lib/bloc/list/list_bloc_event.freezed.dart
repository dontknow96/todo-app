...
class _$CreateItemImpl implements CreateItem {
  const _$CreateItemImpl(this.title, this.description, this.due, this.done);
  ...
  @override
  String toString() {
    return 'ListBlocEvent.createItem(title: $title, description: $description, due: $due, done: $done)';
  }
...
abstract class CreateItem implements ListBlocEvent {
  const factory CreateItem(final String title, final String description,
      final DateTime? due, final DateTime? done) = _$CreateItemImpl;
...
class _$EditItemImpl implements EditItem {
  const _$EditItemImpl(this.title, this.description, this.due, this.done);
  ...
  @override
  String toString() {
    return 'ListBlocEvent.editItem(title: $title, description: $description, due: $due, done: $done)';
  }
...
abstract class EditItem implements ListBlocEvent {
  const factory EditItem(final String title, final String description,
      final DateTime? due, final DateTime? done) = _$EditItemImpl;
